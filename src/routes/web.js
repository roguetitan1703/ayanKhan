...
// import jiliGamesController from "../controllers/JilliGameController.js";
...
const initWebRouter = (app) => {
  ...
  // my new subordinate
  router.post(
    "/api/subordinates-new",
    middlewareController,
    promotionController.downlinerecharge_data,
  );
  router.get(
    "/api/promotion-new",
    middlewareController,
  ...
  router.get(
    ...
    middlewareController,
    paymentController.initiateBkashPay,
  );
  ...
  router.post("/api/webapi/admin/login", accountController.adminlogin); // login
  ...
  router.get(
    ...
    adminController.middlewareAdminController,
    adminController.Wallets,
  ); // get info account
  router.get(
    "/admin/manager/addmoney",
    adminController.middlewareAdminController,
    adminController.addmoney,
  ); // get info account
  router.get(
    "/admin/manager/financeManager",
    adminController.middlewareAdminController,
    adminController.financeManager,
  ); // get info account
  router.get(
  ...
  router.post(
    "/api/webapi/admin/listdemoMember",
    adminController.middlewareAdminController,
    adminController.listdemoMember,
  );
