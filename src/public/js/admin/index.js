...
function showJoinMember(data) {
  ...
  result += `
      ...
      <img class="direct-chat-img" src="${data?.isdemo == 1 ? "/images/demo_user.png" : "/images/myimg.png"}" alt="message user image">
      <div class="direct-chat-text" style="background-color: ${isNumber(bet) ? "#007acc" : bet == "x" ? "#1eb93d" : bet == "d" ? "#f52828" : bet == "t" ? "#ea3af0" : bet == "l" ? "#ffc511" : "#5cba47"}">
       ...
       <div>
      ${data?.isdemo == 1 ? "Demo User" : "Real User"}
      </div>
...
function showJoinMember2(data) {
  ...
  result += `
      ...
      <img class="direct-chat-img" src="${data?.user == 1 ? "/images/demo_user.png" : "/images/myimg.png"}" alt="message user image">
      <div class="direct-chat-text" style="background-color: ${isNumber(bet) ? "#007acc" : bet == "x" ? "#1eb93d" : bet == "d" ? "#f52828" : bet == "t" ? "#ea3af0" : bet == "l" ? "#ffc511" : "#5cba47"}">
        Join ${isNumber(bet) ? bet : bet == "d" ? "Red" : bet == "x" ? "Green" : bet == "t" ? "Violet" : bet == "l" ? "Big" : "Small"} ${money}
      </div>
      <div>
      ${data?.user == 1 ? "Demo User" : "Real User"}
      </div>
      `;
