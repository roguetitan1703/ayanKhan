                    ...
                    ? (o(),
                      de(
                        L,
                        {
                          ...
                          size: "large",
                          color:
                            "linear-gradient(180deg, #4183F8 0%, #434FEE 100%)",
                          onClick: a(f),
                        },
                        {
                          icon: P(() => [
